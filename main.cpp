...
void check()
{
	...
	else if (m_word == "what" || m_word == "who" || m_word == "how" || m_word == "when" || m_word == "where" || m_word == "why")
	{
		...
		{
			typing("My name is Mission.");
		}
		else if (input == "who are you" || input == "who created you" || input == "who made you")
		{
			typing("I am Mission, a virtual assistant");
			usleep(t_const * 300);
			line();
			typing("I was created on 26 jan ,2025 \nBy Tushar Kumbhar");
			usleep(t_const * 300);
		}
		else
			srch(input);
...
void settings()
{
	...
	cout << "\n\nExample 1:\n";
	cout << "Tushar 160 100 40 40";
	cout << "\n\nExample 2:\n";
	cout << "Tushar 150 120 60 30";
	cout << "\n\n\n---> ";
	cin >> un >> ss >> sa >> sp >> ts;
	if ((sa <= 200 && sa > 0) && (sp <= 99 && sp > 0 ))
	{
		save_settings(un, ss, sa, sp, ts);
		typing("Restart Mission to see changes");
	}
	else
	{
...
// 	usleep(t_const * 1000);
// 	system("color c");
// 	cout << setfill(' ') << setw(50) << " Tushar Hacking Lab  \n";
// 	usleep(t_const * 1000);
// 	line();
